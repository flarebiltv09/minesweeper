...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="folder-bar" colspan="${size}">
      <div id="folder1"><a href="https://github.com/flarebiltv09/minesweeper/blob/main/README.md" target="blank">Read Me </a></div>
      <div id="folder2"><a href="https://github.com/flarebiltv09/minesweeper" target="blank">Source Code</a></div>
    </td>
  </tr>
  </tr>
    <tr>
